...
public class Player implements Tank {
    ...
    /**
     * Create small shot and fire it according current gun's position and angle
     */
    private void fireSmallShot() {
        ...
        int power = 6;
        world.addShot(new SmallShot(x, y, Math.cos(angle) * power * world.getAcceleration(), Math.sin(angle) * power * world.getAcceleration(), this.world));
    ...
    private void fireBigShot() {
        ...
        int power = 6;
        world.addShot(new BigShot(x, y, Math.cos(angle) * power * world.getAcceleration(), Math.sin(angle) * power * world.getAcceleration(), this.world));
        lastFire = System.nanoTime();
    }
